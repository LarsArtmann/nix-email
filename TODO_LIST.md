...
| Live-probe native DMARC/ARF report ingestion in the stalwart-e2e VM (mail a report in, query the report store) - upgrades the 06a keep-both verdict from source-grade to ledger-grade | 🔴 `TODO` | High | 30m | `docs/planning/2026-09-15_19-23` §10 06a: "no live probe was run"; README ledger entry carries the same caveat |
...
| Migration tooling compare: stalwart-vandelay vs imapsync on scratch mailboxes (R6)                                             | 🔵 `BLOCKED` (D1: live mailboxes) | Med | 1h | `docs/planning/2026-09-15_19-23` §3 L22a; needs live mailboxes (D1)                                               |
