...
| ~~M2~~  | ~~`certificate` tier option (`self-signed \~~ done — certificate tier shipped in v0.2.0                                                                                                                                                     | ~~acme \~~      | ~~manual`) with mutual-exclusion assertions (nms x509 pattern)~~ | ~~Module~~ | ~~High~~          | ~~60m~~                                                                    |
