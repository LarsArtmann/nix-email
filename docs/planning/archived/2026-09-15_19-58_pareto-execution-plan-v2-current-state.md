...
| ~~08~~ | ~~CI pipe-lint: fail CI on `\~~ done — CI pipe-lint step shipped (3f1854a, ba7645c)                                                                                                                                                                                            | ~~grep -q` inside tests/*.nix testScripts (mechanize the exit-23 lesson)~~ | ~~P1~~ | ~~M~~      | ~~20min~~        | ~~confidence~~    | ~~U~~                    |
